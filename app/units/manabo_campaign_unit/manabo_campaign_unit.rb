module ManaboCampaignUnit
  ...
  # via `invoke(:manabo_campaign_unit, :function_name)`.
  #
  # ```
  # scope(:controller) do
  ...
  # ## render
  # In addition, the view path "app/units/manabo_campaign_unit/views" is added into view_paths.
  # So you can render app/units/manabo_campaign_unit/views/_example.html.erb in invoking.
  #
  # ```
  # scope(:view) do
  #   function(:function_name) do
